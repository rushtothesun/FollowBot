...
namespace FollowBot.Tasks
{
    public class CustomSkillsTask : ITask
    {
        ...
        public Task<bool> Run()
        {
            ...
            if (settings.EnableMoltenShell) CustomSkills.MoltenShell();
            ...
            if (settings.EnableCallMercenary) CustomSkills.CallMercenary();
            if (settings.EnableConvocation) CustomSkills.Convocation();
            if (settings.EnableSoulLink) CustomSkills.SoulLink();
            if (settings.EnableSoulLink2) CustomSkills.SoulLink2();
