...
namespace FollowBot.Tasks
{
    public class DefenseAndFlaskTask : ITask
    {
        ...
        public async Task<bool> Run()
        {
            ...
            //FollowBot.ChaosElixir();
            //FollowBot.SoulLink();
            //FollowBot.MoltenShell();

            //FollowBot.GuardiansBlessingHaste();
            //FollowBot.GuardiansBlessingHatred();
            //FollowBot.GuardiansBlessingMalevolence();
            //FollowBot.GuardiansBlessingDetermination();

            FollowBot.EnduringCry();
            FollowBot.SeismicCry();
            FollowBot.BattlemageCry();
            FollowBot.InfernalCry();
            FollowBot.AncestralCry();
            FollowBot.IntimidatingCry();

            //FollowBot.SentinelUsage();
            #endregion
